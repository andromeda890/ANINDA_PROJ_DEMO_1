...
# Main content area
st.title("Explore Splunk Security Knowledge Repository")
st.subheader("You can ask about Splunk Top 50 Cyber Threats, Top 5 Use Cases for Splunk Security Analytics and Essential Guide to Security, ")
...
with st.form("query_form"):
    text_input = st.text_area("Enter your Splunk query here")  # User input
